...
@interface CustomDatePickerView ()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate> {
    //日期存储数组
...
@property (strong, nonatomic) IBOutlet UIView *showYearView;
...
-(void)setupUI {
    ...
    self.frame=CGRectMake(0, 0, kScrWid, kScrHei);
...
//    self.doneBtn.backgroundColor = [ThemeManager shareManager].bgBlueColor;
}
