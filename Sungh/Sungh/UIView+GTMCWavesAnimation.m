...
@implementation UIView (GTMCWavesAnimation)
...
-(void)Animation{
    ...
    for (int i = 0; i < pulsingCount; i++) {
        ...
        scaleAnimation.toValue = [NSNumber numberWithDouble:2];
...
//        opacityAnimation.keyTimes = @[[NSNumber numberWithDouble:0.0],[NSNumber numberWithDouble:0.25],[NSNumber numberWithDouble:0.5],[NSNumber numberWithDouble:1.0]];
        opacityAnimation.keyTimes = @[[NSNumber numberWithDouble:0.0],[NSNumber numberWithDouble:0.25],[NSNumber numberWithDouble:0.5],[NSNumber numberWithDouble:1.5]];
